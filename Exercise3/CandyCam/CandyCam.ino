...
void loop()
{
  ...
  if (digitalRead(SHUTTER) == HIGH)
  {
    ...
    char *upload;
    int len = sprintf(upload, "{\"zeebeClientID\": \"ID\", \"zeebeClientSecret\": \"SECRET\", \"zeeBeAddress\": \"ADDRESS.bru-2.zeebe.camunda.io:443\", \"processID\": \"TestScriptWorker\", \"variables\": {\"length\": %d,  \"image\": \"", fb->len);
    // doc["zeebeClientID"] = "ID";
    // doc["zeebeClientSecret"] = "SECRET";
    // doc["zeeBeAddress"] = "ADDRESS.bru-2.zeebe.camunda.io:443";
